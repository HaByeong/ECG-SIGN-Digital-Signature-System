...
단순한 심박수가 아닌, ECG 파형 자체를 '서명(Signature)'으로 활용하여 사용자 인증을 수행
...
## 사용 방법
- `PROJECT_DOCUMENTATION.md` 파일을 참조

## 참고사항
- 실제 ECG 센서 없이도 더미 데이터로 테스트 가능
- Python 서버 실행 시 로컬 IP 주소를 Android 앱에 설정
- 사용자 데이터는 `Software/Signal_Processing/user_data/users.json`에 저장
